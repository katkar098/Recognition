    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Face-Recognition-Attendance-System-main (2)/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/Manually Attendance.csv'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Face-Recognition-Attendance-System-main (2)\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\Manually Attendance.csv"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                # Create table for Attendance
                date_for_DB = datetime.datetime.now().strftime("%m/%d/%Y")
                DB_Table_name = str(
                ...
                root.configure(background='grey80')
                cs = 'C:\\Face-Recognition-Attendance-System-main (2)\\Face-Recognition-Attendance-System-main' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Face-Recognition-Attendance-System-main (2)\Face-Recognition-Attendance-System-main\Attendance\Face attendance.csv"')
    ...
    def log_in():
        ...
        if username == 'shubham':
            if password == 'shubham123':
                ...
                cs = 'C:/Face-Recognition-Attendance-System-main (2)/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
